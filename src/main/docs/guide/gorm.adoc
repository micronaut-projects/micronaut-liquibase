...
include::{liquibasetests}/groovy/io/micronaut/configuration/dbmigration/liquibase/docs/Book.groovy[tag=clazz]
----
...
----
include::{liquibasetests}/groovy/io/micronaut/configuration/dbmigration/liquibase/docs/GormSpec.groovy[tag=yamlconfig,indent=0]
----
...
.src/main/resources/application.yml
----
include::{liquibasetests}/groovy/io/micronaut/configuration/dbmigration/liquibasetests/docs/GormMultipleDataSourcesSpec.groovy[tag=yamlconfig,indent=0]
----
